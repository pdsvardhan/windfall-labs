...
- **DVM validation vs Trendlyne (snapshot 2026-06-18, Spearman):** momentum **0.835**, durability **0.875** (v2 Piotroski-led, commit 65d75aa), valuation **0.407** (v1, commit 28dc401). NEXT lifts: valuation v2 (historical-multiple percentile) ; momentum tweak (distance-from-MA). Durability ROCE/D-E for history is an opt-in (~0.03 live-match cost — measured NOT free).
